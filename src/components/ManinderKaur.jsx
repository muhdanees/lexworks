...
export default function ManinderKaur() {
  return (
    <>
        ...
        <div className="container py-5">
          <div className="row g-5">
            ...
            <div className="col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
              <h5 className="sub-title mb-4 pe-3">Maninder Kaur</h5>
              ...
              <p>
                ...
                strategic advice and representation in both contentious and
              ...
              <p>
                ...
                needs, and advocating effectively on their behalf. She is also
                dedicated to continuous professional development, actively
                participating in relevant workshops and seminars to stay current
                in the evolving fields of taxation and intellectual property
                law.
              </p>
