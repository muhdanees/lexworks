          ...
          <div className="row g-5">
            <div className="col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
              <div className="bg-light">
                <img
                  src="img/akhil-krishnan-maggu-inside.jpg"
            ...
            <div className="col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
              ...
              <h3 className="customs-heading mb-4">
                LL.M., London South Bank University, 2017
              </h3>
              ...
              <p>
                ...
                optimization, and regulatory compliance has made him a trusted
                advisor for businesses navigating complex legal and financial
                landscapes.
              </p>
